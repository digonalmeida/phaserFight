function Platform(gameplay, x, y){
    ...
    this.body.collides([this.gameplay.wallCollsionGroup, 
                        this.gameplay.playerCollisionGroup, 
                        this.gameplay.ammoCollisionGroup, 
                        this.gameplay.ropeCollisionGroup,
                        this.gameplay.zombieCollisionGroup]);
